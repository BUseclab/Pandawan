...
class KernelInfo(gdb.Command):
    ...
    def invoke(self, arg, from_tty):
        ...
        #except Exception as e:
            ...
            #print(f"name = nada|nada|nada",file=file_out)
        ...
        if versions_int >= (2,6):
            ...
            try:
                ...
                print(f"task.stack_offset = 0",file=file_out)
            if versions_int >= (2,6,29):
                ...
                print(f"task.real_cred_offset = {uid_offset}", file=file_out)
                print(f"task.cred_offset = {uid_offset}", file=file_out)
            ...
            if versions_int >= (2,6,29):
                try:
                    ...
                    print(f"cred.uid_offset = {int(uid_off) - uid_offset}", file=file_out)
                ...
                print(f"cred.uid_offset = {int(uid_off) - uid_offset}", file=file_out)
                print(f"cred.gid_offset = {int(gid_off) - uid_offset}", file=file_out)
                print(f"cred.euid_offset = {int(euid_off) - uid_offset}", file=file_out)
                print(f"cred.egid_offset = {int(egid_off) - uid_offset}", file=file_out)
            ...
            print_offset("struct mm_struct",		"start_code",	"mm")
            print_offset("struct mm_struct",		"end_code",	"mm")
            ...
            try:
                ...
                print(f"path.d_name_offset = 0",file=file_out)
            ...
            try:
                ...
                print(f"path.d_dname_offset = 0",file=file_out)
