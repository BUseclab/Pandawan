...
if (${FIRMAE_NET}); then
  QEMU_NETWORK="-device pcnet,netdev=net0 -netdev user,id=net0 -device pcnet,netdev=net1 -netdev user,id=net1 -device pcnet,netdev=net2 -netdev user,id=net2 -device pcnet,netdev=net3 -netdev user,id=net3"
else
