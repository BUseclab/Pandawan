...
append = f"root={config['rootfs']} rdinit=/firmadyne/preInit.sh console={config['tty']} nandsim.parts=64,64,64,64,64,64,64,64,64,64 \
          rw debug ignore_loglevel print-fatal-signals=1 \
          user_debug=31 mem=256M firmadyne.syscall=0 firmadyne.reboot=1 firmadyne.execute=1 firmadyne.procfs=1 firmadyne.devfs=1"
...
kernel_conf = f"/Pandawan/kernel_profiles/firmadyne_profiles.conf"
